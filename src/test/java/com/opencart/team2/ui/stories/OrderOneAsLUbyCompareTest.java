...
public class OrderOneAsLUbyCompareTest extends TestRunner {
    ...
    public void Test() {
        ...
        new ProductPageBL().comparePage(1);

        new ComparePageBL().addProductToCard(0);
        ...
        new CheckoutBL().clickBillingContinueButton().clickExistingAddressButton(0).selectExistingAddress("1");
