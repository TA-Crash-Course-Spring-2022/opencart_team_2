package com.opencart.team2.utils;
...
public class MainValuesProvider {
    ...
    public int getExpected4(){return Integer.parseInt(properties.getProperty("expected"));}

    public int getExpected2(){return Integer.parseInt(properties.getProperty("expected2"));}

    public int getExpected1(){return Integer.parseInt(properties.getProperty("expected1"));}

    public int getExpected3(){return Integer.parseInt(properties.getProperty("expected3"));}
    ...
    public String getExistingAddress1() {
        return properties.getProperty("existingAddress1");
    }
}
