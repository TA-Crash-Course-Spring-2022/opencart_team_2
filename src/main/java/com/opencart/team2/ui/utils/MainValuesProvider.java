package com.opencart.team2.ui.utils;
...
public class MainValuesProvider {
    ...
    public String getNewCurrency() {return properties.getProperty("newCurrencyName");}

    public String getProductName() {return properties.getProperty("productName");}
    ...
    public int getId1() {
        return Integer.parseInt(properties.getProperty("id1"));
    }

    public int getId2() {
        return Integer.parseInt(properties.getProperty("id2"));
    }

    public int getId3() {
        return Integer.parseInt(properties.getProperty("id3"));
    }

    public int getId4() {
        return Integer.parseInt(properties.getProperty("id4"));
    }
