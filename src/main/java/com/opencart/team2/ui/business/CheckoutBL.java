...
public class CheckoutBL {
    ...
    public CheckoutBL clickLastContinueButton() {
        checkoutPage.getLastContinueButton().click();
        return this;
    }
    ...
    public String getSuccessOrder() {return checkoutPage.getCheckAssert().getText();}
}
